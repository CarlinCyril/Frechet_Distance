...
void frechet_rec(int *matrix, uint32_t i1, uint32_t i2, uint32_t j1, uint32_t j2, Coordonates *p, Coordonates *q);

void frechet_optim(int *matrix, uint32_t i1, uint32_t i2, uint32_t j1, uint32_t j2, Coordonates *p, Coordonates *q);
